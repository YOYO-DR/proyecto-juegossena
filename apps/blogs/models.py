...
class Mockups(models.Model):
    imagen=models.ImageField(upload_to=f'{MEDIA_URL}blogs/mockups/%Y/%m/' if 'WEBSITE_HOSTNAME' in os.environ else 'blogs/mockups/%Y/%m/',null=True,blank=True, verbose_name='Mockup')
    nombre=models.CharField(max_length=100,null=False,blank=False,verbose_name="Nombre mockup")
    hecho=models.BooleanField(default=False,null=False,verbose_name="Hecho")
